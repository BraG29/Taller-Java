...
//import com.traffic.toll.application.impl.TollServiceImpl;
...
//import com.traffic.toll.infraestructure.persistence.TariffRepositoryImpl;
//import com.traffic.toll.infraestructure.persistence.VehicleRepositoryImpl;
...
//
//    @WeldSetup
//    public WeldInitiator weld = WeldInitiator.from(TollServiceImpl.class)
...
//    @Test
//    void isEnableSuccessTrueTest()
//            throws InvalidVehicleException, IOException {
//
//        OkHttpClient client = new OkHttpClient();
//
//        String jsonBody = "{\"id\":1,\"licensePlateNumber\":\"ABC-123\"}";
//        RequestBody body = RequestBody.create(jsonBody, MediaType.get("application/json"));
//
//        Request request = new Request.Builder()
//                .url("http://0.0.0.0:8081/toll-traffic/api/toll/isEnable")
//                .post(body)
//                .build();
//
...
////    @Test
////    void isEnableSuccessFalseTest(TollServiceImpl tollController) throws InvalidVehicleException {
...
////    @Test
////    void isEnableErrorTest(TollServiceImpl tollController){
...
////    @Test
////    void updateTariffSuccessTest(TollServiceImpl tollController, TariffRepository tariffRepository) {
////        Double amount = 150D;
////
...
////    @Test
////    void updateTariffErrorTest(TollServiceImpl tollController) {
////        Double amount = -150D;
////
////        Assertions.assertThrows(IllegalArgumentException.class,
////                () -> tollController.updateCommonTariff(amount));
